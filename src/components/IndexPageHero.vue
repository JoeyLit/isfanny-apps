<template>
  <div class="q-pa-md hero__container">
    ...
    <div>
      ...
      <h5 class="q-ma-none">
        <span class="">The World of Memes</span>
      </h5>
      <p>Spread a Smile to Everyone</p>
    </div>
  </div>
</template>
...
.hero__container {
  ...
  /* background: white url("../assets/pattern1.png") repeat left top; */
  ...
  text-align: center;
  /* box-shadow: 0 1px 3px rgba(128, 128, 128, 0.178); */
}
