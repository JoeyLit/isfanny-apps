    ...
    <div v-if="type === 'text'" class="meme__cards--item-footer">
      ...
      <div class="meme__cards--item-footer-icons">
        <div class="like__meme">
          ...
          <p class="q-ma-none">999+</p>
        </div>

        <!-- Share button -->
        <!-- <div class="share__meme">
          <i class="uil uil-share"></i>
          <p class="q-ma-none">Share</p>
        </div> -->
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    // textURL() {
    //   return `https://res.cloudinary.com/mememe/image/upload/c_scale,w_500/c_fit,l_text:Neucha_26_bold_line_spacing_6_center:${this.description},w_350,h_250/fl_layer_apply/isFanny_text_background_zibbja`;
    // },
    memeDate() {
      const formattedString = date.formatDate(this.createdAt, "MMMM");
