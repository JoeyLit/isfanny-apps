  ...
  <div class="meme-details__page">
    <div class="meme-details__container">
      ...
      <div class="meme-details">
        ...
        <div v-else-if="allSearchMemes.length === 0" class="meme-details__left">
          ...
          <div v-if="isMemeAlreadyCached" class="new-memes__section">
            ...
            <div class="new-memes__card">
              <div
                ...
                v-for="meme in allSearchMemesMinusOne"
                :key="meme._id"
              >
...
export default {
  ...
  computed: {
    ...
    allSearchMemesMinusOne() {
      let memes2 = this.allSearchMemes.slice(0, this.allSearchMemes.length - 1);
      return memes2;
    },
    catchedMemeTags() {
      let tag = [];
  ...
  methods: {
    ...mapActions(["fetchMoreSearchMemes", "fetchSearchValue"]),
    fetchSingleMeme() {
      // first approach
      const memes = this.allSearchMemes;
      // memes.filter((meme) => {
    ...
    async nextMeme() {
      try {
        ...
        let memes = this.allSearchMemes;
        let memesCount = this.allSearchMemes.length;
        let currentMemeIndex = memes.findIndex(
    ...
    displayRightMemes(e) {
      ...
      let memes = this.allSearchMemesMinusOne;
